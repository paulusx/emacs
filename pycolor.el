...
(defface font-lock-builtin-extra-face '((default :inherit font-lock-builtin-face)) "extra face" )
(defface font-lock-number-face '((default :inherit font-lock-constant-face)) "extra number face" )
...
(defvar python-font-lock-keywords
  ...
  `(,(rx symbol-start
    ...
    (,(rx symbol-start
          (or "self" "cls" "klass")
          symbol-end) . 'font-lock-builtin-extra-face)

    ;; numbers
    (,(rx (? ?-) (? ?.) symbol-start
	  (+ digit) (? ?. (* digit)) (? (any "e" "E" ) (? ?-) (+ digit))    
          symbol-end)  . 'font-lock-number-face)
