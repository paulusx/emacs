(custom-set-variables
 ...
 '(compile-command
   "cd ~/projects/artecsdk/ && LANG= scons -f ~/projects/build-system/SConstruct --profiles-file=~/projects/build-system/profiles/linux.yaml -j13 --use-profile=fast-build  --module=artec-{base,scanning}")
 '(custom-safe-themes
   (quote
